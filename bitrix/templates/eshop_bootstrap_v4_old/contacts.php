<div id="b3624" class="block-wrapper block-01-big-with-text-3-1 contacts_outer">
 <section class="landing-block landing-block-node-img u-bg-overlay g-flex-centered g-bg-img-hero g-bg-size-cover g-mb-20 g-bg-image g-bg g-pt-30 g-pb-30 g-height-auto">
	<div class="landing-block-node-container container text-center u-bg-overlay__inner g-mx-0 bounce">
		<h2 class="landing-block-node-title g-line-height-1 g-mt-20 text-left g-color-white g-font-size-46 g-font-weight-600 g-mb-10 g-font-nunito text-uppercase u-heading-v2-12--2 contacts_title" style="--color: ; --border-color: ; --border-color--hover: ">
		Контакты </h2>
