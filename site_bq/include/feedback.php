...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/site_bq/about/idea/",
            "PATH_IDEA_POST" => "/site_bq/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/site_bq/login/?forgot_password=yes",
            "REGISTER_URL" => "/site_bq/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
