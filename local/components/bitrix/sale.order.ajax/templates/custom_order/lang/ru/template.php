...
$MESS['SOA_ERROR_CONSENT'] = 'Необходимо дать согласие на обработку персональных данных';


$MESS["SOA_ORDER_SUC_TEXT"] = "Спасибо! Ваш заказ принят в обработку. Наш менеджер скоро свяжется с вами для подтверждения деталей. Информация о заказе также отправлена на вашу электронную почту.";
$MESS["SOA_TO_PERSONAL_CABINET"] = "Перейти в личный кабинет";
$MESS["SOA_TO_MAIN"] = "Вернуться на главную";