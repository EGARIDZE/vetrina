...
$APPLICATION->AddViewContent('cowl_buttons', '<div class="basket-back font_12"><a href="'.TSolution::GetFrontParametrValue('BASKET_PAGE_URL').'" class="basket-back__link no-decoration secondary-to-title-hover">'.Loc::getMessage('GO_TO_BASKET').'</a></div>');
?>
	<NOSCRIPT>
...
else
{
			...
			<div class="col-md-9 bx-soa">
				...
				<div class="pandd">
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						...
						<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								...
								<div class="change-info btn btn-secondary-black "><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
							<div class="bx-soa-section-content container-fluid"></div>
					...
					<? else: ?>
						...
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								<h2 class="bx-soa-section-title"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?><span class="city_destination"><?=Loc::getMessage('TITLE_SOA_DESTINATION')?></span><span class="change_city font_13 colored "><?=Loc::getMessage('TITLE_SOA_CHANGE_CITY')?></span></h2>
								<div class="change-info btn btn-secondary-black "><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
							<div class="bx-soa-section-location bx-soa-section-title-container"></div>
							<div class="bx-soa-section-content container-fluid"></div>
	...
	<?
	$arScripts = ['phone_input', 'hint'];
	if (TSolution::GetFrontParametrValue('PHONE_MASK')) {
