...
<div class="row mb-4 catalog_section_dep1 container m-auto py-5" >
  <? if ($isFilter || $isSidebar): ?>
        <div class="col-lg-3 col-md-4 col-sm-5 catalog_section_dep1_sidebar">
            <?= (isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '') ?>
            <?
    ...
    <div class="pb-4 ">
        ...
        if (ModuleManager::isModuleInstalled("sale")) {
            ...
            //region Product Gift
            if (!empty($arRecomData) && $arParams['USE_GIFTS_SECTION'] === 'N') {
                ?>
                <div class="row">
