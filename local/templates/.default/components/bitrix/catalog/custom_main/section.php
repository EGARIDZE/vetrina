...
// Определяем, нужно ли показывать фильтр и сайдбар. Всегда считаем, что фильтр вертикальный.
...
<div class="row">
	...
	<? if ($showSidebar): ?>
		<div class="col-md-3 col-sm-4">
			...
			if ($isFilter): ?>
				<div class="bx-sidebar-block">
					<? $APPLICATION->IncludeComponent(
						...
						"catalog_custom", // Ваш шаблон фильтра
						array(
			...
			<? // Дополнительная область сайдбара
			if ($isSidebar): ?>
				<div class="hidden-xs">
					<? $APPLICATION->IncludeComponent(
						"bitrix:main.include",
	...
	<? // --- Основной контент --- ?>
	<div class="<?= ($showSidebar ? "col-md-9 col-sm-8" : "col-xs-12") ?>">
		<div class="row">
			<div class="col-xs-12">
				...
				$APPLICATION->IncludeComponent(
					...
					"v2_custom", // Ваш кастомный шаблон
					array(
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
						...
						"VIEW_MODE" => "TILE", // Режим отображения плиткой
				...
				$intSectionID = $APPLICATION->IncludeComponent(
					...
					"catalog-section-custom", // Ваш кастомный шаблон
					array(
						"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
						"IBLOCK_ID" => $arParams["IBLOCK_ID"],
