...
if ($isFilter || $isSidebar): ?>
	<div
		class="col-md-3 col-sm-4<?= (isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '') ?>">

		<?// НАЧАЛО: Добавление меню каталога ?>
		<? $APPLICATION->IncludeComponent(
			"bitrix:menu",
			"catalog_custom", // или ваш шаблон меню, например, "left"
			array(
				"ROOT_MENU_TYPE" => "left",
				"MENU_CACHE_TYPE" => "A",
				...
				"USE_EXT" => "Y", // Обязательно 'Y' для подключения .left.menu_ext.php
				"DELAY" => "N",
		...
		<?// КОНЕЦ: Добавление меню каталога ?>
