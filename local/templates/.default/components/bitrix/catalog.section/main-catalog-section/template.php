...
<?if ($arParams["SET_BLOCK_TITLE"]){?>
	<h2 class="text-capitalize my-4"><?=$arParams["SET_BLOCK_TITLE"];?></h2>
<?}?>
					...
					<div class="row <?=$rowData['CLASS']?> " data-entity="items-row">
						...
						switch ($rowData['VARIANT'])
						{
							...
							case 3:
								...
								{
									?>
									<div class="col-6  col-sm-6 col-lg-3 product-item-small-card p-2">
										<div class="border-cart-item">
											<?
											$APPLICATION->IncludeComponent(
												'bitrix:catalog.item',
												'catalog-items-main',
