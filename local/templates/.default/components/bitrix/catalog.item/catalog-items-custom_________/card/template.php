	...
	if (!empty($arParams['PRODUCT_BLOCKS_ORDER']))
	{
		foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
		{
			switch ($blockName)
			{
				...
				case 'buttons':
					?>
					<div class="product-item-info-container product-item-hidden mx-4 my-3" data-entity="buttons-block">
						<?
						if (!$haveOffers)
						{
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<button class="btn btn-primary main-btn-catalog <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
											...
											<span class="text-btn-cart"><?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?></span>
									</button>
								</div>
								<?
							}
							...
							if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
							{
								...
								<div class="product-item-button-container">
									...
									<div id="<?=$itemIds['BASKET_ACTIONS']?>" <?=($actualItem['CAN_BUY'] ? '' : 'style="display: none;"')?>>
										<button class="btn btn-primary main-btn-catalog py-3 <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
												href="javascript:void(0)" rel="nofollow">
												<i class="fas fa-shopping-cart mr-2"></i>
												<span class="text-btn-cart"><?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?></span>
										</button>
						...
						<div class="product-item-info-container product-item-hidden" id="<?=$itemIds['PROP_DIV']?>">
							...
							foreach ($arParams['SKU_PROPS'] as $skuProperty)
							{
								...
								if (!isset($item['SKU_TREE_VALUES'][$propertyId]))
									continue;
								?>
								<div data-entity="sku-block" style="margin: 0px 20px;">
													...
													foreach ($skuProperty['VALUES'] as $value)
													{
														...
														else
														{
															...
															<li class="col-xl-3 col-sm-6 product-item-scu-item-text-container" title="<?=$value['NAME']?>"
																...
																<div class="product-item-scu-item-text-block py-3">
																	<div class="d-flex justify-content-center product-item-scu-item-text"><?=$value['NAME']?></div>
																</div>
															</li>
															<?
														}
